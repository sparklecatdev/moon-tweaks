<template>
  <div id="about-container">
    <Card
      ...
      title="About Moon Tweaks"
      subtitle="Learn a bit more about Moon Tweaks, what it is and how it works"
      background="about"
      id="about-card"
    ...
    >
      <div id="cards-item">
        ...
        >
          <p id="about-us">
            Moon Tweaks is a modification pack for Lunar Client. By modifying
        ...
        <div id="little-cards">
          ...
          <CardItem
            ...
            <button @click="openMoonTweaksFolder()" class="button">
              <i class="fa-solid fa-folder-open button-icon"></i>
              Open Moon Tweaks folder
            </button>
          </CardItem>
          <CardItem
            title="Lunar Client"
...
export default {
  ...
  methods: {
    ...
    /**
     * Opens the Moon Tweaks folder
     */
    openMoonTweaksFolder() {
      remote.shell.openPath(constants.MOONTWEAKS_DIR);
    },
  },
};
</script>
