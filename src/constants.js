...
export default {
  links: {
    GH_DISCUSSIONS: 'https://github.com/sparklecatdev/moon-tweaks/discussions',
    GITHUB: 'https://github.com/sparklecatdev/moon-tweaks',
    GITHUB_RELEASES_API:
      'https://api.github.com/repos/sparklecatdev/moon-tweaks/releases/latest',
    DISCORD: 'https://github.com/sparklecatdev/moon-tweaks/discussions',
  ...
  MOONTWEAKS_DIR: join(homedir(), '.lunarclient', 'moontweaks'),
};
